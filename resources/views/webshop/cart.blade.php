...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="{{asset('/vendor/backward/html5shiv.js')}}"></script>
    <script src="{{asset('/vendor/backward/respond.min.js')}}"></script>
    <![endif]-->
</head>
                                        ...
                                        <div class="col12">
                                            ...
                                            <table class="table cart-table-list table-responsive">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" class="close">
                                                            <img src="{{asset('/img/product/close.png')}}" alt="" />
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a href="#" class="m-bot-20 footer-logo">
                                <img class="retina" src="{{asset('/img/logo-dark.png')}}" alt="" />
                            </a>
                        ...
                        <div class="col-md-3">
                            ...
                            <ul class="r-work">
                                <li>
                                    <a href="#">
                                        <img src="{{asset('/img/recent-work/1.jpg')}}" alt="" />
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{asset('/img/recent-work/2.jpg')}}" alt="" />
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{asset('/img/recent-work/3.jpg')}}" alt="" />
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{asset('/img/recent-work/4.jpg')}}" alt="" />
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{asset('/img/recent-work/5.jpg')}}" alt="" />
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{asset('/img/recent-work/6.jpg')}}" alt="" />
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{asset('/img/recent-work/7.jpg')}}" alt="" />
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{asset('/img/recent-work/8.jpg')}}" alt="" />
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{asset('/img/recent-work/9.jpg')}}" alt="" />
                                    </a>
                                </li>
                            </ul>
                        </div>
